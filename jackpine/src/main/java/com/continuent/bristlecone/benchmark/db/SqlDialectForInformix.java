...
/**
 * Informix DBMS dialect information. 
 * 
 * @author rhodges
 */
public class SqlDialectForInformix extends AbstractSqlDialect
{
	
  public SqlDialectForInformix() {

  }
	
  /** Return the Informix driver. */
