...
public class ReadSpatialLineIntersectsLargestArea extends SpatialScenarioBase
{
  ...
  public void prepare() throws Exception
  {
	  SpatialSqlDialect dialect = helper.getSpatialSqlDialect(); 
	    ...
	    pstmtArray[0] = conn.prepareStatement(sql[0],ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
	    pstmtArray[1] = conn.prepareStatement(sql[1],ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
