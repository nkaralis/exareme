...
{
  /** my addition */
  public static  enum SupportedSqlDialect {Informix, Ingres, Mysql, PostgreSQL, Exareme };
  ...
  public abstract String getMaxRowidFromSpatialTablePointlmMerge();
